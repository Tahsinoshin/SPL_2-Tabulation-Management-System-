      ...
      <div class="row d-flex justify-content-center">
         <div class="col-sm-4 d-flex justify-content-center text-center">
            <div class="admin_form">
               <form action="update_staff_pass.php" method="POST">
                  <div class="mb-3">
                     <div class="form-group">
                        <label class="label_text">Enter Staff ID to update password</label>
                  ...
                  <button type="submit" name="reset_password" class="btn btn-primary">update staff password</button>
